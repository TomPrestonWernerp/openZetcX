...
export const DEFAULT_OFFICIAL_PLUGIN_MARKETPLACE_URL = "https://raw.githubusercontent.com/TomPrestonWernerp/OH-Plugins/main/marketplace.json";
...
export function createDefaultPluginMarketplace({ openZetcXHome, env = process.env, fetchImpl }: any = {}) {
  ...
  const localIndex = openZetcXHome ? path.join(openZetcXHome, "plugin-marketplace", "marketplace.json") : null;
