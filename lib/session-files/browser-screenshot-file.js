...
export function browserScreenshotPath(openZetcXHome, sessionPath, { base64, mimeType } = {}) {
  return path.join(
    sessionFilesCacheDir(openZetcXHome, sessionPath),
...
export async function persistBrowserScreenshotFile({
  ...
  const filePath = browserScreenshotPath(openZetcXHome, sessionPath, { base64, mimeType });
