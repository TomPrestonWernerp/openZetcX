...
export async function materializeBridgeInboundFiles({
  ...
  files,
  registerSessionFile,
}: { openZetcXHome?: any; sessionId?: any; sessionPath?: any; files?: any[]; registerSessionFile?: any } = {}) {
  if (!files?.length) {
    return { sessionFiles: [], imageAttachmentPaths: [], displayAttachments: [] };
  }
  if (!openZetcXHome) throw new Error("bridge inbound file materialization requires openZetcXHome");
