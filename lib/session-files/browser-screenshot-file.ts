...
export function browserScreenshotPath(openZetcXHome, sessionPath, { base64, mimeType, sessionId = null }: { base64?: any; mimeType?: any; sessionId?: any } = {}) {
  return path.join(
    sessionFilesCacheDir(openZetcXHome, { sessionId, sessionPath }),
...
export async function persistBrowserScreenshotFile({
  ...
  mimeType = "image/png",
  registerSessionFile,
}: { openZetcXHome?: any; sessionId?: any; sessionPath?: any; base64?: any; mimeType?: string; registerSessionFile?: any } = {}) {
  if (typeof registerSessionFile !== "function") {
    throw new Error("browser screenshot requires registerSessionFile");
  }
  const filePath = browserScreenshotPath(openZetcXHome, sessionPath, { base64, mimeType, sessionId });
