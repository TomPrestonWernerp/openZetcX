...
export function sessionFilesCacheDir(openZetcXHome, sessionPath) {
  if (!openZetcXHome) throw new Error("openZetcXHome is required for session file cache");
  ...
  return path.join(openZetcXHome, "session-files", hash);
}
