...
export class PathGuard {
  ...
  constructor(policy) {
    ...
    this.openZetcXHome = this._resolveReal(policy.openZetcXHome) || path.resolve(policy.openZetcXHome);
  ...
  getAccessLevel(rawPath) {
    ...
    // 8. openZetcXHome 内未匹配 → 安全兜底 BLOCKED
    if (this._isInside(resolved, this.openZetcXHome)) return AccessLevel.BLOCKED;
