...
async function materializeDocxImages({
  ...
  if (!openZetcXHome || !sessionPath || typeof recordFileOperation !== "function") {
  ...
  const dir = sessionFilesCacheDir(openZetcXHome, { sessionId, sessionPath });
...
export function wrapReadOfficeMedia(tool, cwd, {
  ...
  getSessionIdForPath,
  recordFileOperation,
}: { openZetcXHome?: any; getVisionBridge?: any; isVisionAuxiliaryEnabled?: any; getSessionPath?: any; getSessionIdForPath?: any; recordFileOperation?: any } = {}) {
