 ...
 */
export async function createChannel(channelsDir, { id, name, description, members, intro, workspaceRoot = undefined }) {
  ...
  return withFileLock(filePath, async () => {
    ...
    if (typeof workspaceRoot === "string" && workspaceRoot.trim()) meta.workspaceRoot = workspaceRoot.trim();
