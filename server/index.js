...
import { configureProcessPiSdkEnv, ensureHanaPiSdkDirs, resolveopenZetcXHome } from "../shared/hana-runtime-paths.js";
...
const engine = new HanaEngine({ openZetcXHome, productDir });
...
app.route("/api", createServerIdentityRoute({ hanakoHome: engine.openZetcXHome, appVersion }));
...
try {
  ...
  console.log(`[server] openZetcX Server 运行在 http://${host}:${actualPort}`);
