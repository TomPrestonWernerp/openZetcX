...
const SERVER_API_CONTRACT_VERSION = "openzetcx-api-2026-05-sessions-marketplace";
...
const engine = new HanaEngine({ openZetcXHome, productDir, appVersion });
...
app.route("/api", createWebAuthRoute({
  hanakoHome: engine.openZetcXHome,
...
app.get("/api/health", async (c) => {
  ...
  return c.json({
    status: "ok",
    version: appVersion,
    apiContractVersion: SERVER_API_CONTRACT_VERSION,
    capabilities: {
      sessionsSwitch: true,
