...
```text
https://raw.githubusercontent.com/TomPrestonWernerp/OH-Plugins/main/marketplace.json
```
...
```json
{
  ...
  "plugins": [{
    ...
    "distribution": {
      "kind": "release",
      "packageUrl": "https://github.com/TomPrestonWernerp/OH-Plugins/releases/download/demo-v1.0.0/demo.zip",
      "sha256": "..."
    },
    "versions": [
      {
