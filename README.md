...
目前的openZetc还是只是一个本地化的agent工具，它只是将龙虾、hermes等一些agent工具做了本地化集成，该项目的最初目的是降低普通人使用龙虾的门槛，后面为个人探索多agent协同交互的学习内容；当前项目需求正在持续扩大，已经超过了一个本地工具的个人应用范畴；在人员精力和时间安排上都希望给予一定支持；
## 功能特性
