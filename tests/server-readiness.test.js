...
describe("isModuleResolutionError", () => {
  ...
  it("issue #484 真实日志 → 抽出 ws", () => {
    // 来自 https://github.com/liliMozi/openZetcX/issues/484
    const real = [
      ...
      "[stderr]         ^\n",
      "[stderr] \n",
      "[stderr] Error [ERR_MODULE_NOT_FOUND]: Cannot find package 'ws' imported from D:\\1\\openopenZetcX\\resources\\server\\bundle\\index.js\n",
    ];
