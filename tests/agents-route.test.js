...
describe("agents route", () => {
  ...
  it("refreshes identity and ishiki template files when yuan changes", async () => {
    const agentId = "hana";
    const agentDir = path.join(tempRoot, agentId);
    ...
    fs.writeFileSync(path.join(agentDir, "ishiki.md"), "old ishiki\n", "utf-8");
    fs.writeFileSync(path.join(agentDir, "public-ishiki.md"), "old public\n", "utf-8");
    fs.writeFileSync(
      path.join(productDir, "identity-templates", "ming.md"),
      "{{agentName}} / {{userName}} / ming identity\n",
      "utf-8",
    );
    fs.writeFileSync(path.join(productDir, "ishiki-templates", "ming.md"), "ming ishiki\n", "utf-8");
    fs.writeFileSync(path.join(productDir, "public-ishiki-templates", "ming.md"), "ming public\n", "utf-8");
    ...
    expect(res.status).toBe(200);
    expect(fs.readFileSync(path.join(agentDir, "identity.md"), "utf-8")).toBe("Hana / Tester / ming identity\n");
    expect(fs.readFileSync(path.join(agentDir, "ishiki.md"), "utf-8")).toBe("ming ishiki\n");
    expect(fs.readFileSync(path.join(agentDir, "public-ishiki.md"), "utf-8")).toBe("ming public\n");
