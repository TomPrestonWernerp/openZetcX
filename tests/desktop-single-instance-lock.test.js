...
describe("desktop client single instance lock", () => {
  it("sets the dev userData namespace before requesting the lock", () => {
    const { app } = makeApp();
    const defaultHome = path.join("C:", "Users", "me", ".openZetcX");
    const devHome = path.join("C:", "Users", "me", ".openZetcX-dev");

    const acquired = configureClientSingleInstance(app, {
      openZetcXHome: devHome,
      defaultHome,
    ...
    expect(app.setPath).toHaveBeenCalledWith(
      "userData",
      path.join("C:", "Users", "me", "AppData", "Roaming", "openZetcX-dev"),
    );
  ...
  it("exits a duplicate client before registering second-instance handlers", () => {
    ...
    const acquired = configureClientSingleInstance(app, {
      openZetcXHome: path.join("C:", "Users", "me", ".openZetcX"),
      defaultHome: path.join("C:", "Users", "me", ".openZetcX"),
      onSecondInstance: vi.fn(),
    });
