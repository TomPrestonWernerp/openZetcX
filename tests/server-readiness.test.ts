...
describe("isModuleResolutionError", () => {
  ...
  it("issue #484 真实日志 → 抽出 ws", () => {
    // 来自 https://github.com/TomPrestonWernerp/openZetcX/issues/484
    const real = [
...
describe("startup root error extraction", () => {
  ...
  it("extracts server entry import failures as the root startup error", () => {
    const root = extractRootServerStartupError([
      ...
      "[stderr]     at MSe (file:///Applications/openZetcX.app/Contents/Resources/server/bundle/index.js:55420:11)\n",
      "--- GPU Startup ---\n",
