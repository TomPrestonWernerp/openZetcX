...
describe("log redaction", () => {
  ...
  it("redacts local home paths across macOS, Linux, Windows, and file URLs", () => {
    const raw = [
      ...
      "/home/bob/.openZetcX/auth.json",
      "C:\\Users\\carol\\AppData\\Roaming\\openZetcX\\crash.log",
      "C:/Users/dave/AppData/Roaming/openZetcX/crash.log",
    ].join("\n");
  ...
  it("redacts object values by sensitive key without mutating the original object", () => {
    const raw = {
      userId: "u-123456",
      chatId: "chat-789",
      sessionPath: "/Users/alice/.openZetcX/agents/a/sessions/s.md",
      nested: {
    ...
    expect(cleaned).toEqual({
      userId: "[redacted]",
      chatId: "[redacted]",
      sessionPath: "~/.openZetcX/agents/a/sessions/s.md",
      nested: {
        password: "[redacted]",
        safe: "hello",
      },
