...
} = await import("../core/message-utils.ts");

describe("Windows session path validation", () => {
  it("accepts the same path when only drive and user-directory casing differs", () => {
    const agentsDir = "C:\\Users\\Alice\\.openZetcX\\agents";
    const sessionPath = "c:\\users\\alice\\.openZetcX\\agents\\hana\\sessions\\old.jsonl";
  ...
  it("treats archived desktop sessions as desktop but not active", () => {
    const agentsDir = "C:\\Users\\Alice\\.openZetcX\\agents";
    const sessionPath = "c:\\users\\alice\\.openZetcX\\agents\\hana\\sessions\\archived\\old.jsonl";
  ...
  it("still rejects sibling paths that only share a textual prefix", () => {
    const agentsDir = "C:\\Users\\Alice\\.openZetcX\\agents";
    const sessionPath = "C:\\Users\\Alice\\.openZetcX\\agents-evil\\hana\\sessions\\old.jsonl";
