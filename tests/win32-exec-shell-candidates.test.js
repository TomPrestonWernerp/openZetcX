...
describe("win32 bundled shell candidates", () => {
  it("discovers PortableGit Bash before legacy MinGit fallbacks", () => {
    const gitRoot = "C:\\Program Files\\openZetcX\\resources\\git";
    ...
    const candidates = __testing.getBundledShellCandidates(
      { HANA_ROOT: "C:\\Program Files\\openZetcX\\resources\\server" },
      {
        resourcesPath: "C:\\Program Files\\openZetcX\\resources",
