...
describe("Windows legacy sandbox migration", () => {
  ...
  it("collects old ACL roots and stale Hana AppContainer profile names", () => {
    const existing = new Set([
      ...
      "D:\\",
      "C:\\Users\\Hana",
      "C:\\Users\\Hana\\.openZetcX",
      "C:\\Users\\Hana\\.openZetcX\\.ephemeral",
      "C:\\Users\\Hana\\.openZetcX\\agents",
      "C:\\Users\\Hana\\.openZetcX\\session-files",
      "C:\\Users\\Hana\\.openZetcX\\uploads",
    ...
    const readdirSync = vi.fn((target) => {
      if (target === "C:\\Users\\Hana\\AppData\\Local\\Packages") {
        return [
          dirent("com.openZetcX.sandbox.1288.475900"),
          dirent("Microsoft.WindowsCalculator_8wekyb3d8bbwe"),
          dirent("com.openZetcX.sandbox.5104.475988"),
          dirent("com.openZetcX.sandbox.file", false),
        ];
      }
      return [];
    });
    ...
    expect(targets.profileNames).toEqual([
      "com.openZetcX.sandbox.1288.475900",
      "com.openZetcX.sandbox.5104.475988",
    ]);
  });
  ...
  it("runs cleanup through the helper and treats ACL findings as a diagnostic result", async () => {
    ...
    const result = await runWin32LegacySandboxMigration({
      ...
      targets: {
        aclPaths: ["C:\\"],
        profileNames: ["com.openZetcX.sandbox.1288.475900"],
      },
      spawn,
    });
