...
describe("PluginMarketplace", () => {
  ...
  it("resolves readmePath relative to URL marketplaces", async () => {
    const marketplace = new PluginMarketplace({
      indexUrl: "https://raw.githubusercontent.com/TomPrestonWernerp/OH-Plugins/main/marketplace.json",
      fetchImpl: async (url) => {
        ...
        expect(url).toBe("https://raw.githubusercontent.com/TomPrestonWernerp/OH-Plugins/main/plugins/demo/README.md");
    ...
    expect(data.plugins[0].readmeUrl).toBe("https://raw.githubusercontent.com/TomPrestonWernerp/OH-Plugins/main/plugins/demo/README.md");
