...
describe("buildWin32SandboxHelperArgs", () => {
  it("emits requested AppContainer network capabilities only when requested", () => {
    const base = {
      cwd: "C:\\work",
      executable: "C:\\openZetcX\\resources\\git\\bin\\bash.exe",
      args: ["-lc", "curl https://example.com"],
      grants: {
        writePaths: ["C:\\work"],
        denyReadPaths: ["C:\\Users\\Hana\\.openZetcX\\auth.json"],
      },
    };
    ...
    expect(buildWin32SandboxHelperArgs({
      ...
      "C:\\work",
      "--deny-read",
      "C:\\Users\\Hana\\.openZetcX\\auth.json",
      "--",
      "C:\\openZetcX\\resources\\git\\bin\\bash.exe",
      "-lc",
