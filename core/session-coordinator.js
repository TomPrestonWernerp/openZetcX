...
export class SessionCoordinator {
  ...
  async createSession(sessionMgr, cwd, memoryEnabled = true, model = null, {
    ...
    // (read/bash/edit/write/grep/find/ls) from sessionTools + openZetcX
   ...
   * openZetcX 侧的 sessionPath 控制权释放出来，再把 SDK abort 和资源清理
   ...
   *   2. unsub — 取消 openZetcX 层的 session 事件转发
   ...
   * 的对象引用。openZetcX 这边 ModelRegistry.refresh() 之后会重建模型对象，
