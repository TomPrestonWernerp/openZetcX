...
export function resourceTicketKeyPath(openZetcXHome: any) {
  assertNonEmpty(openZetcXHome, "openZetcXHome");
  return path.join(openZetcXHome, "security", RESOURCE_TICKET_KEY_FILE);
}

function signBody(openZetcXHome: any, body: any) {
  return crypto
...
function readOrCreateTicketKey(openZetcXHome: any) {
  const filePath = resourceTicketKeyPath(openZetcXHome);
  try {
