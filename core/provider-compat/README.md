...
本架构由 commit `2a9ea17`（README 奠基）至 `0d87520`（llm-client 收口）一系列 commit 引入，根因来自 issue [#468](https://github.com/TomPrestonWernerp/openZetcX/issues/468) 的 DeepSeek 思考模式 400。
