...
const CronConfirmBlock = memo(function CronConfirmBlock({ block, sessionPath }: { block: any; sessionPath?: string }) {
  ...
  const fallbackAgentName = useStore(s => s.agentName) || 'openZetcX';
  const fallbackAgentYuan = useStore(s => s.agentYuan) || 'openZetcX';
...
BLOCK_RENDERERS['knowledge_sources'] = KnowledgeSourcesBlock as any;
