...
export function CharacterCardPreviewOverlay({
  ...
  const taKey = 'openzetcx';
  const taDisplayName = 'openZetc';
  ...
  const yuanIconUrl = assetUrl('yuanIcon') || assetUrl('avatar') || frontUrl;

  const overlay = (
    <div className={styles['character-card-preview-overlay']} data-yuan={taKey} role="dialog" aria-modal="true">
      {detailOpen ? (
              ...
              <div className={styles['character-card-face']}>
                ...
                <div className={styles['character-card-face-grid']}>
                  <div className={styles['character-card-face-cell']}>
                    <span className={styles['character-card-face-label']}>TA</span>
