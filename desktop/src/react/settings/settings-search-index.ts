...
const BUILT_IN_SETTINGS_SEARCH_ENTRIES: SettingsSearchEntry[] = [
  {
    ...
    aliases: ['assistant', 'agent', 'persona', 'role', 'avatar', 'memory', 'ta', '助手', '人设', '角色', '头像', '记忆'],
  },
  {
    id: 'me-profile',
    tabId: 'me',
  ...
  {
    id: 'work-channel-workspace',
    tabId: 'work',
    titleKey: 'settings.work.channelWorkspaceTitle',
    pathKeys: ['settings.tabs.work'],
    aliases: ['cluster workspace', 'group workspace', 'collaboration permission', '集群工作台', '群组工作台', '集群权限', '协作权限'],
  },
  {
    id: 'work-heartbeat',
    tabId: 'work',
